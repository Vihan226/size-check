...
function setup() {
  ...
  pacman=createSprite(width-500,height-290)
  pacman.scale=.3     
  
  line1=createSprite(width/1.75-10,height-240,width-width/3,10);
  line1.shapeColor="blue"
 
  
  line2=createSprite(width/1.75-10,height-305,width-width/3,10);
  line2.shapeColor="blue"
  
  line3=createSprite(width/.9-width/2,height-190,10)
  ...
  line8=createSprite(width/1.75-10,height-405,width-width/3,10)
  line8.shapeColor="blue"

  
  line9=createSprite(width/1.37-width/2,height-350,10);
